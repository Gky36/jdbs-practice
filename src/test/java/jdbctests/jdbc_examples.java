...
public class jdbc_examples
{
    ...
    public void test2() throws SQLException {
        ...
        Connection connection = DriverManager.getConnection(dburl,dbUsername,dbPassword);
        // TYPE_SCROLL_INSENSITIVE allow us navigate up and down in query result
        // CONCUR_READ_ONLY -> only get information, do not update the result
        ...
        // because we have to get the pointer beginning
    ...
    public void test3() throws SQLException {
        ...
        // get the database related inside the dbMetedata object
